function results = auditorySalience(fName,doDisplay)
% results = auditoryPerceptualOnsets(fName,doDisplay)
%
% An adaptation by Anne S. Warlaumont of Coath et al.'s function, auditoryPerceptualOnsets.m
%
...
if doDisplay
    ...
    plot(ts,s*max(abs(saliency)),'c',t,saliency,'k'),grid,
end
